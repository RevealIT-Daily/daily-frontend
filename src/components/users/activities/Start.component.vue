    ...
    <v-container>
        <v-row align="center" justify="center">
            <v-col cols="12" xs="12" md="12" sm="12" class="mr-5">
                <v-tabs v-model="tab" background-color="primary" color="basil" dark grow height="50">
                    <v-tabs-slider color="white"></v-tabs-slider>
                    <v-tab v-for="item in items" :key="item" @click="tabActivity(item)">
                        {{ item }}
                    </v-tab>
                ...
                <v-card>
                    <v-card-title>
                        <v-row>
                            <v-col cols="4" class="">
                                <v-text-field v-model="search" prepend-icon="search" label="Search" single-line hide-details color="blue">
                                </v-text-field>
                            </v-col>
                    ...
                    <v-card-text>
                        ...
                        <v-data-table :search="search" :headers="headers" :items="desserts" :page.sync="page" :items-per-page="itemsPerPage" class="elevation-1" hide-default-footer @page-count="pageCount = $event">
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-icon small class="ml-2" color="info" @click="deleteItem(item)">
                                    remove_red_eye
                                </v-icon>
...
export default {
    ...
    data: () => ({
        tab: null,
        items: [
            'Start', 'Planning', 'Excecution', 'Control', 'Closing'
        ],
        search: '',
        page: 1,
        pageCount: 0,
