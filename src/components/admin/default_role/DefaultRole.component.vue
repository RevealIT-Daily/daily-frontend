            ...
            <v-col cols="12" xs="12" md="12" sm="12" class="mr-5">
                ...
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        <v-data-table :search="search" :headers="headers" :items="defaultRole" :page.sync="page" :items-per-page="itemsPerPage" class="elevation-1" hide-default-footer @page-count="pageCount = $event">
